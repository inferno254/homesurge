...
class _CompareTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final showBathrooms = properties.any((p) => PropertyCard.shouldShowBathrooms(p.bedrooms, p.propertyType));
    ...
    return SingleChildScrollView(
      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            _LabelColumn(showBathrooms: showBathrooms),
            ...properties.map((p) => _PropertyColumn(property: p, showBathrooms: showBathrooms)),
          ],
        ),
      ),
    );
...
class _LabelColumn extends StatelessWidget {
  const _LabelColumn({required this.showBathrooms});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ..._rowLabels(showBathrooms).map((label) => Padding(
...
class _PropertyColumn extends StatelessWidget {
  const _PropertyColumn({required this.property, required this.showBathrooms});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (showBathrooms) _ValueCell(property.bathrooms != null ? '${property.bathrooms} bath' : '—'),
...
List<String> _rowLabels(bool showBathrooms) => [
      'Price',
      'Location',
      'Type',
      'Bedrooms',
      if (showBathrooms) 'Bathrooms',
      'Size',
      'Furnished',
    ];
