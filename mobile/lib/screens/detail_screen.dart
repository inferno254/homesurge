...
class _DetailScreenState extends ConsumerState<DetailScreen> {
  ...
  void didChangeDependencies() {
    ...
    _pageController ??= PageController(initialPage: _currentImage, viewportFraction: 1.0);
  }
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    _InfoChipRow(property: property),
                     ...
                     Container(
                       ...
                       child: Row(
                         children: [
                           const Icon(Icons.location_on_outlined, size: 16, color: Color(0xFF22D3EE)),
                     ...
                     if (property.amenities.isNotEmpty) ...[
                       ...
                       Wrap(
                         ...
                         children: property.amenities.map((a) => Chip(
                           label: Text(a, style: const TextStyle(color: Colors.white70)),
...
class _ImageCarousel extends StatelessWidget {
  const _ImageCarousel({required this.property, required this.currentIndex, this.pageController, required this.onPageChanged});
  ...
  Widget build(BuildContext context) {
    ...
    for (final u in property.imageUrls) {
          ...
          Positioned(
            ...
            child: _CarouselArrow(
              ...
              onTap: () {
                ...
                if (prev >= 0) pageController?.animateToPage(prev, duration: const Duration(milliseconds: 250), curve: Curves.easeInOut);
              },
            ),
          ),
          Positioned(
            ...
            child: _CarouselArrow(
              ...
              onTap: () {
                ...
                if (next < images.length) pageController?.animateToPage(next, duration: const Duration(milliseconds: 250), curve: Curves.easeInOut);
              },
            ),
          ),
          Positioned(
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: [
        ...
        if (PropertyCard.shouldShowBathrooms(property.bedrooms, property.propertyType))
