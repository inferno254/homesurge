...
class _AdminMapScreenState extends State<AdminMapScreen> {
  ...
  // Placeholder for future property marker filtering
  ...
  Future<void> _onPlaceSearch(String query) async {
    ...
    final result = await http.get(
      Uri.parse('https://nominatim.openstreetmap.org/search?q=$query&format=json&limit=1&countrycodes=ke'),
    );
